...
public class ExamsScheduleAdapter extends RecyclerView.Adapter<ExamsScheduleAdapter.MyViewHolder> {

    private Activity activity;
    private ArrayList<Exams> data ;

    public ExamsScheduleAdapter(Activity activity, ArrayList<Exams> data) {
