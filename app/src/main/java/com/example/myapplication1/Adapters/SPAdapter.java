...
public class SPAdapter extends BaseExpandableListAdapter {

    Context context;
    List<transcript_subjects> listGroup;
    HashMap <transcript_subjects,List<SPchild>> listItem ;
    public SPAdapter(Context context, List<transcript_subjects> listGroup, HashMap<transcript_subjects,List<SPchild>>listItem){
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        transcript_subjects group =(transcript_subjects) getGroup(groupPosition);
       if (convertView ==null){
